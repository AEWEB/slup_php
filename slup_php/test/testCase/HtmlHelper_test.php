<?php
	class HtmlHelper_test extends Lf_testCase{
		...
		public function testTextArea(){
			...
			$this->getControl()->equals(htmlspecialchars("<textarea cols=\"".($cols=40)."\" rows=\"".($rows=10)."\" name=\"".($name="test")."\" "
			...
			//rows設定有
			$this->getControl()->equals(htmlspecialchars("<textarea cols=\"".($cols=40)."\" rows=\"".($rows=20)."\" name=\"".($name="test")."\" "
					.">".($value="value")."</textarea>",ENT_QUOTES,AppConfig::character),

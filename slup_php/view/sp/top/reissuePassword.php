<div id="basic" data-role="page" data-title="<?php print(AppConfig::formalName); ?>">
  ...
  <div data-role="content">
	...
	?>
 	...
 	<?php print($controller->getActionForm("reissuePassword","reissuePassword","POST","",$controller->getUser()));?>
  ...
  <div data-role="footer">
	 ...
	 <a href="<?php 
	 	print($controller->getActionUrl("top","reissueId")); ?>" data-role="button"><?php 
	 		print(ModelResource::sl_user_id);
	 	?>再通知</a>
    <?php 
